...
stats::var(na_data$Post.Test, use = 'complete.obs') # complete.obs returns a value
...
na_omit_data <- stats::na.omit(na_data) # This is also working pretty fine.
...
stats::sd(na_omit_data$Post.Test)
