...
str(Orange) # Checking the structure of the
...
orange_data %>% 
        dplyr::select(age) %>% 
        nrow()
Orangelm <- lm(circumference ~ age, data = orange_data) 
summary(Orangelm) 
```
...
abline(Orangelm, lwd = 4, lty = "dotted", col = "magenta") 
