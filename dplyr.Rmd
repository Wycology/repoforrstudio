...
Mutate normally adds the newly created column as the last in the tibble. However, that can be changed by specifying where you want it by .after or .before arguments.
